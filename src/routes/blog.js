...
router.put('/store/:_id/edit', token.verifyToken, uploadCloud.single('image'), blogController.putBlog);
router.get('/search', token.verifyToken, blogController.searchBlog);
